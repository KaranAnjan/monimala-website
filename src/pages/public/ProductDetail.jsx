          ...
          <div className="space-y-6 animate-fade-in" style={{ animationDelay: '0.1s' }}>
            ...
            <div className="space-y-3 pt-4">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-4 px-6 rounded-xl transition-all duration-300 transform hover:shadow-lg hover:-translate-y-1 hover:scale-105 active:scale-95 flex items-center justify-center gap-2 text-lg group"
              >
                <ShoppingCart className="h-6 w-6 group-hover:scale-125 transition-transform" />
                Add to Cart
              </button>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white font-bold py-4 px-4 rounded-xl transition-all duration-300 transform hover:shadow-lg hover:-translate-y-1 hover:scale-105 active:scale-95 flex items-center justify-center gap-2 group"
                >
                ...
                <button
                  onClick={handleCall}
                  className="bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-bold py-4 px-4 rounded-xl transition-all duration-300 transform hover:shadow-lg hover:-translate-y-1 hover:scale-105 active:scale-95 flex items-center justify-center gap-2 group"
                >
